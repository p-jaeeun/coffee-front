...
export class AdminApi {
  ...
  async callAdminPage() {
    ...
    try {
      result = await this.ajax.sendAjaxGet(
        "http://172.16.101.87:8080/hiddenc/admin/cafe"
      );
    } catch (e) {
      console.log("error:" + e);
    }
  ...
  async callMemberList() {
    ...
    try {
      result = await this.ajax.sendAjaxGet(
        "http://172.16.101.87:8080/hiddenc/admin/user"
      );
    } catch (e) {
      console.log("error:" + e);
    }
  ...
  async callReviseCafe() {
    ...
    try {
      result = await this.ajax.sendAjaxGet(
        "http://172.16.101.87:8080/hiddenc/admin/addcafe/byuser"
      );
    } catch (e) {
      console.log("error:" + e);
    }
  ...
  async addCafe(cafeData) {
    ...
    try {
      result = await this.ajax.sendAjaxPostFile(
        "http://172.16.101.87:8080/hiddenc/admin/addcafe",
        cafeData
      );
    } catch (e) {
      console.log("error:" + e);
